...
if(isset($_POST['forminsc']))
{
	echo "ok";
	if(!empty($_POST['nom']) AND !empty($_POST['prenom']) AND !empty($_POST['date_de_naissance']) AND !empty($_POST['email']) AND !empty($_POST['numtel']) AND !empty($_POST['mdp']) AND !empty($_POST['mdp2']) )
	{
		echo"oui";
	}
	else
				...
				<table align="center">
					...
					<tr>
						...
						<td>
							...
							<input type="submit" name="forminsc" value="Confirmer" />
						</td>
					</tr>
				</table>
			</label>
